...
[![Docker Image](https://img.shields.io/badge/ghcr.io-dnsdist--sidecar-blue?logo=docker&logoColor=white)](https://github.com/StelianMorariu/losmuertos-dnsdist/pkgs/container/dnsdist-sidecar) [![GitHub release](https://img.shields.io/github/v/release/StelianMorariu/losmuertos-dnsdist)](https://github.com/StelianMorariu/losmuertos-dnsdist/releases)
...
services:
  dnsdist-sidecar:
    ...
    environment:
      ...
      REFRESH_INTERVAL: 20000    # milliseconds (default: 20 seconds)
    volumes:
...
| `REFRESH_INTERVAL` | No | `20000` | Page refresh interval in milliseconds |
